...
- name: billypix_not_set_in_window
  code: |-
    ...
    // This is the last synchronous function available in the chain
    assertApi('injectScript').wasCalled();

    // NOTE: As the gtm.Onsucces is called aynchrnously after the script has been loaded
    // Then I can't do this check, as the unit test does not wait for async excecution
